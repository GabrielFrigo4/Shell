...
| **[CONTEXTS.md](CONTEXTS.md)**         | Especificação dos 4 contextos de ambiente (`desktop`, `server`, `container`, `wsl`), variáveis exportadas e otimizações por carga de trabalho.                    |
...
| **[THEMES.md](THEMES.md)**             | Contrato visual dos prompts (Bash, Zsh, POSIX sh), paleta de cores ANSI, suporte a Nerd Fonts, integração Git/Got e fallback 1:1 em TTY bruto.                    |
